...
/*   Updated: 2019/07/25 15:31:49 by ajulanov         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int 				**create_maps(t_map *map);
int					**create_grid(t_map *map);
int 				create_img(t_map *map);
int 				center(t_map *map);
...
void draw(t_map *map)
{
	map->map_xy = create_maps(map);
	map->map_xy = make_map(map);
	map->x_grid = create_grid(map);
	map->x_grid = create_grid(map);
	create_img(map);
	center(map);
	// draw_grid(map);
	printf("checkpoint: draw \n");
}
