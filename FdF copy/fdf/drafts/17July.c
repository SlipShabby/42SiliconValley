...
/*   Updated: 2019/07/17 14:36:31 by ajulanov         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	x = map->brs.delta.x = abs(map->x1 - map->x2);
// 	y = map->brs.delta.y = abs(map->y1 - map->y2);
// 	p = 2 * map->brs.delta.y - map->delta.x;
// 	if (map->x1 > map->x2)
// 	{
// 		x = map->x2;
// 		y = map->y1;
...
// 	if (p < 0)
// 	{
// 		p = p + 2 * map->brs.delta.y;
// 	}
// 	else
// 	{
// 		y +=1;
// 		p = p + 2 * (map->brs.delta.y - ma->brs.delta.x);
// 	}
// 	mlx_pixel_put(map->mlx, map->win, x, y, 0x0FF0FF);
// }
// }
...
// 	map->size_line = map->X_res * 8;
// 	map->n = 0;
// 	map->data.img_ptr = mlx_new_image(map->mlx, map->X_res, map->Y_res);
// 	map->data.img_ptr = mlx_get_data_addr(map->data.img_ptr, &(map->bits_per_pixel), &(map->size_line), &(map->n));
// }

// void redraw_image(t_map *map)
// {
// 	map->xy.y = 0;
// 	while (map->)
// 	mlx_put_image_to_window(map->mlx, map->win, map->data.img_ptr, 0, 0);
// }
...
// 	ft_bzero(map->data, map->X_res * map->Y_res * (map->bits_per_pixel / 8));
// 	image = (int *)(map->data);
// 	i = 0;
